...
Если хочешь, я могу сразу сделать **ещё один уровень — привязку каждой формулы к конкретным узлам и связям**, чтобы прямо видно было, какие формулы используют **Hyperloop, Core, Condensate, Export**.
