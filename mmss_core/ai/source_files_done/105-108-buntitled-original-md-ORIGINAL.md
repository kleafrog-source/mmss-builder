...
flowchart LR
    ...
    %% Узлы-Роли
    MK[Meta-Keeper<br/>Интеграция]
    MA[Meta-Archon-Φ<br/>Управление операторами]
    HA[Hyperloop ASE<br/>Синтез правил]
    FL[F_loopx<br/>Рекурсивная оптимизация]
    ME[Meta-Evolver<br/>Самоадаптация]
    MV[Meta-Validator<br/>Проверка]
    MST[Meta-Strategist<br/>Стратегия]
    MI[Meta-Integrator<br/>Связывание]
    MAN[Meta-Analyzer<br/>Анализ графа]
